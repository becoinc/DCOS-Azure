...
resource "null_resource" "dcos_metrics_prometheus_large_private" {

    depends_on = [
        "azurerm_virtual_machine.dcosLargePrivateAgent"
    ]

    count = "${azurerm_virtual_machine.dcosLargePrivateAgent.count}"
